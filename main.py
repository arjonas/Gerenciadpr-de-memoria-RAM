...
def atualizar():
    ...
    free = tkinter.Label(text=f'Memória livre :{round(livre_mem/1000000000,3)} MB', font=('Abys',
                                                                                    10 ,'bold'))
    ...
    usando = tkinter.Label(text=f'Memória Utilizada pelo sistema :{round(usada_mem / 1000000000, 3)}'
                                f'MB ',
                          font=('Abys', 10, 'bold'))
